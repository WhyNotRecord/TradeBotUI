...
In tradebotui-labels_en.properties:
tradebotui=My application
tradebotui[description]=My application does this and that

In tradebotui-messages_en.properties:
